        ...
        <div>
            <div className="grid justify-items-center items-center lg:grid-cols-2 md:grid-cols-2 gap-10 md:gap-20 lg:gap-15">
                ...
                <div className='prose prose-sm lg:prose-lg'>
                    ...
                    <h3 className="font-bold grid place-content-center md:block">We Provide Many Features You Can Use</h3>

                    <p className="">You can explore the features that we provide with fun and have their own functions each feature.</p>

                    <div className='grid place-content-center md:block prose'>
